...
.setDescription(`<a:red:1072937597183213669> ${message.author} .e <Etiket> İsim Yaş Yazarak Kayıt Eder Misin ? <a:wertica_kristal:1071348757205090325>`)
.setColor("BLACK")
...
message.guild.members.cache.get(kullanıcı.id).roles.add(ids.rolErkek2)
...
\`❯\` __Kullanıcının Rolleri :__ <@&${erkek}>, <@&${ids.rolErkek2}> **Olarak Güncellendi!**
